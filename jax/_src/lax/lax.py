...
def standard_primitive(shape_rule, dtype_rule, name, translation_rule=None,
  ...
  named_shape_rule = named_shape_rule or partial(standard_named_shape_rule, prim)
...
def standard_abstract_eval(prim, shape_rule, dtype_rule, weak_type_rule,
  ...
  if least_specialized is ConcreteArray:
    ...
    named_shapes = named_shape_rule(*args, **kwargs)
...
def standard_named_shape_rule(prim, *avals, **kwargs):
...
reduce_p = standard_primitive(_reduce_shape_rule, _reduce_dtype_rule,
                              ...
                              named_shape_rule=_reduce_named_shape_rule,
                              weak_type_rule=_reduce_weak_type_rule)
